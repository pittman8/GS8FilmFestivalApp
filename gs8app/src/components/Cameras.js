            ...
            <div style={styles.rowDivStyle}>
                <div style={colDivStyle}>
                    <Card style={cardCameraStyle}>
                        ...
                        >
                            <img
                                src={require('../img/icon_PDF.jpg')}
                                alt="PDF icon for Canon Auto Zoom 814"
                            />
                        </Button>
                        <br />
                        <Button
                ...
                <div style={colDivStyle}>
                    <Card style={cardCameraStyle}>
                        ...
                        >
                            <img
                                src={require('../img/icon_PDF.jpg')}
                                alt="PDF icon for Sankyo XL 300"
                            />
                        </Button>
                        <br />
                        <Button
                ...
                <div style={colDivStyle}>
                    <Card style={cardCameraStyle}>
                        ...
                        >
                            <img
                                src={require('../img/icon_PDF.jpg')}
                                alt="PDF icon for Minolta XL Sound 84"
                            />
                        </Button>
                        <br />
                        <Button
                ...
                <div style={colDivStyle}>
                    <Card style={cardCameraStyle}>
                        ...
                        >
                            <img
                                src={require('../img/icon_PDF.jpg')}
                                alt="PDF icon for GAF802 Manual"
                            />
                        </Button>
                        <br />
                        <Button
