        ...
        <div className = "vid-list-container">
            <div className = "vid-list">
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/QtC3Bo9B0yI/0.jpg" alt="Cute and funny cat videos"/></div>
                    <div className="desc">THE BEST CUTE AND FUNNY CAT VIDEOS OF 2019!</div>
                </div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/AcL0MeVZIxM/0.jpg" alt="Funny Dog Video"/></div>
                    <div className="desc">Try Not To Laugh At This Ultimate Funny Dog Video Compilation</div>
                </div>
                <div
                    className="vid-item"
                    onClick={() => {
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/eg6kNoJmzkY/0.jpg" alt="Jessica Hernandez & the Deltas - Dead Brains"></img></div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/_Tz7KROhuAw/0.jpg" alt="Barbatuques"></img></div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/F1f-gn_mG8M/0.jpg" alt="Eleanor Turner plays Baroque Flamenco"></img></div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/fB8UTheTR7s/0.jpg" alt="Sleepy Man Banjo Boys: Bluegrass"></img></div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/0SNhAKyXtC8/0.jpg" alt="Edmar Castaneda: NPR Music Tiny Desk Concert"></img></div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/RTHI_uGyfTM/0.jpg" alt="Winter Harp performs Caravan"></img></div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/abQRt6p8T7g/0.jpg" alt="The Avett Brothers Tiny Desk Concert"></img></div>
                ...
                <div className="vid-item"
                    ...
                    <div className="thumb"><img src="http://img.youtube.com/vi/fpmN9JorFew/0.jpg" alt="Tracy Chapman - Give Me One Reason"></img></div>
